export const WORK_DATA = [
  ...
  },
  {
    ...
    name: "Find Me",
    description:
      "A real time application for looking up locations and current movements of users.",
    stacks: "Reactjs, Google Maps Api, css/scss,Javascript (ES6+)",
    link: "https://tk-location.netlify.app/",
  },
  {
    id: 5,
    name: "WhatsApp Clone",
  ...
  },
  {
    ...
    name: "OMDB Movies",
    description:
      "Find any movies, and also add movies for recommendations and nominations.",
    stacks: "Reactjs,css/scss, OMDB API,Javascript (ES6+)",
    link: "https://6002fddd34bcda059bb3483b--shoppie-movies.netlify.app/",
  },
];
