...
const ProjectCard = ({ data }: DataProp) => {
  ...
  return (
    <motion.div
      className={`w-full lg:w-[375px] mb-[2em] ${
    ...
    >
      ...
      />
      <section
        className={`px-4 py-4 hover:scale-105 cursor-text  hover:translate-y-1 duration-300 transition ease-in-out cursor-pointer' md:px-8 md:py-4 flex items-start justify-start flex-col`}
      >
        <div
        ...
        <div
          ...
          } mt-[1em] text-lg md:text-xl lg:text-xl font-light leading-relaxed`}
        >
          {data.description}
        </div>
        ...
        <div className='flex justify-between gap-6 items-center mt-2 md:mt-4'>
          <a href={`${data.live}`} target='_blank'>
            <div className='flex items-center gap-3'>
              ...
              <span
                ...
                } text-base md:text-lg font-normal underline leading-relaxed`}
              >
                Live Preview
              </span>
            </div>
